...
// import profileImage from '/images/abiye.jpg';
    ...
    <>
      <AboutContainer id="about">
        ...
        <AboutContent>
          <Heading>
            <h1>
              About Me <Emoji>💝</Emoji>
            </h1>
          </Heading>

          <p>
            I am software developer specialized in web technologies like
            ReactJs, React Native, Nextjs, javascript, HTML5, CSS3, SQL, java,
          ...
          <p>
            I'm excited to connect with other developers and designers who share
            my passion for creating amazing user experiences. Thanks for taking
            the time to get to know me!
          </p>

          <CTAButton href="/cv/Abebe.pdf" download target="_blank">
            Download CV
          </CTAButton>
        </AboutContent>
      </AboutContainer>
